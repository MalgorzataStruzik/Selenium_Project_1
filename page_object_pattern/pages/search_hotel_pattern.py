class SearchHotelPage:
    ...
    def set_city(self, city):
        self.driver.find_element_by_xpath(self.search_hotel_span_xpath)
    ...
    def set_date_range(self, check_in, check_out):
        self.driver.find_element_by_name(self.check_in_input_name).send_keys('12/03/2020')
        self.driver.find_element_by_name(self.check_out_input_name).send_keys('13/09/2020')
